...
@section('content')
	...
	<p class="control has-addons">
		<input class="input is-expanded" name="search" value="" v-model="query" />
	...
	<table class="table is-bordered is-striped">
		...
		<tbody>
			<tr v-show="results.length == 0"> <td colspan="4" class="center"> @if(!empty($search)) No results found @else No search query @endif </td> </tr>
